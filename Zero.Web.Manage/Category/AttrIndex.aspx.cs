...
{
    public partial class AttrIndex : Zero.Pages.ManagePage
    {
        ...
        private void Operate()
        {
            ...
            switch (action)
            {
                case "audit":
                    ...
                    AttrService.ChangeAttrStatus(ids, targetStatus);
                    break;

                //case "selectCategory":
                //    int cateId = Requests.FormInt("targetCateList");
                //    AttrCtrl.ChangeAttrCate(ids, cateId);
                //    //先批量调取数据，验证属性名称是否重覆
                //    //最后修改状态
                ...
                case "delete":
                    AttrService.DeleteAttrList(ids);
                    break;
