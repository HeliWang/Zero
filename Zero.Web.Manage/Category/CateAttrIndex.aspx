<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CateAttrIndex.aspx.cs" Inherits="Zero.Web.Manage.Category.CateAttrIndex" %>
		    ...
		    <table class="z-tb-grid">
				...
				<asp:Repeater ID="DateList" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td><%#Eval("CAID")%></td>
					        <td><input name="ids" type="checkbox" value="<%#Eval("CAID")%>" /></td>
                            <td><%#Eval("AttrId")%></td>
					        <td><%#Eval("Attr")%></td>
                            <td><%#Eval("CateId")%></td>
                            <td><%#Eval("CateName")%></td>
                            ...
                            <td> <a href="cateAttrValueIndex.aspx?attrId=<%#Eval("AttrId")%>" class="z-add"></a></td>
					        <td>
                                <a href="cateAttrEdit.aspx?attrId=<%#Eval("AttrId")%>" class="z-edit"></a>
