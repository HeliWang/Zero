...
namespace Zero.Category.Bll
{
    public class CateAttrService
    {
        ...
        /// <returns></returns>
        public static CateAttrInfo AddCateAttrInfo(CateAttrInfo info)
        {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        public static int UpdateCateAttrInfo(CateAttrInfo info)
        {
        ...
        public static void ChangeCateAttrStatus(string ids, int status)
        {
        ...
        /// </summary>
        /// <param name="ids"></param>
        public static void DeleteCateAttrList(string ids)
        {
        ...
        /// <returns></returns>
        public static CateAttrInfo GetCateAttrInfo(int caId)
        {
        ...
        /// <returns></returns>
        public static bool ExistCateAttr(int cateId, int attrId)
        {
        ...
        /// <param name="CateAttrName"></param>
        /// <returns></returns>
        public static bool ExistCateAttr(int CAID, int cateId, int attrId)
        {
        ...
        /// <returns></returns>
        public static List<CateAttrExpandInfo> GetCateAttrList(Paging paging, string condition)
        {
        ...
        /// <param name="condition"></param>
        /// <returns></returns>
        public static List<CateAttrExpandInfo> GetCateAttrList(string condition)
        {
            string sql=string.Format("select * from [Cate_View_Attr] {0}", condition);
